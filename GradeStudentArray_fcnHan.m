function [ArrayStudents] = GradeStudentArray_fcnHan(agconfig, ArrayStudents, assignmentSolution, studentResultsFileWriter)
%
...
for i = 1:length(student_output)    
    ...
    elseif isa(correct_output{i}, 'function_handle')
        ...
        [t12,t22,temp_points] = assign_points_value_based(temp_student_output, temp_correct_output, testCase);
